use flight_computer::{config::FlightComputerConfig, tasks::{ALTIMETER_SD_CARD_CHANNEL, FLIGHT_STATE_WATCH, GPS_SD_CARD_CHANNEL, IMU_SD_CARD_CHANNEL, LATEST_ALTITUDE_SIGNAL, altimeter_task, finite_state_machine_task, gps_task, imu_task, postcard::postcard_server_task, sd_card_task}};
use tokio::select;
