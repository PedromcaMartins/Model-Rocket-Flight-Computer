...
```
● Connected  1.2ms  |  Ping: 1.2ms  |  Session: 14:30:00  |  Records: 42  |  [1] Telemetry  [2] Logs  [3] Controls  |  [q] quit
```
...
| **Launchpad** | Origin axys | Fixed position at launchpad coordinates. |
